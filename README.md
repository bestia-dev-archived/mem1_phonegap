...
This code example is based on the Hello sample generated by PhoneGap Desktop.  
...
phonegap serve
```
6. Open the browser with the URL the command have printed ussually http://localhost:3000  
...
8. Type in the URL of the command phonegap serve  
